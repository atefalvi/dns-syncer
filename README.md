...
![Version](https://img.shields.io/badge/version-0.2.8-FF5C38)
...
For change-only alerts, leave only `RECORD_UPDATED` selected. `SYNC_COMPLETE`
fires after every scheduled check, including checks where all records were
already unchanged.
